  ...
  return (
    <div className={cn('border border-[var(--color-border)] rounded-2xl overflow-hidden', className)}>
      <button
        ...
        className="w-full flex items-center justify-between px-6 py-4 text-left font-medium hover:bg-[#FFF5EE] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--color-accent)]"
      >
        <span>{title}</span>
